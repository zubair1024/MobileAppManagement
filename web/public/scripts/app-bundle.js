...
define('app-navbar/app-navbar',['exports', 'aurelia-framework', '../http'], function (exports, _aureliaFramework, _http) {
  ...
  var AppNavbar = exports.AppNavbar = (_dec = (0, _aureliaFramework.inject)(_aureliaFramework.Aurelia, _http.Http), _dec(_class = function () {
    function AppNavbar(aurelia, http) {
      ...
      this.alarmCountPoller = setInterval(function () {
        if (App.currentUser) {}
      }, 10 * 1000);
    }
  ...
  var Overview = exports.Overview = (_dec = (0, _aureliaFramework.inject)(_http.Http, _appState.AppState), _dec(_class = function () {
    ...
    Overview.prototype.renderPowerOutputBar = function renderPowerOutputBar() {
      ...
      this.client.get('/statistics/projectUtilization/poweroutputkwdaily').then(function (res) {
        if (res && res.data) {
          ...
          _this2.loadingPowerOutputBar = false;
        }
      });
    };
    ...
    Overview.prototype.renderliveOperationalStatisticsPie = function renderliveOperationalStatisticsPie() {
      ...
      this.client.get('/statistics/liveoperationalstatistic').then(function (res) {
        if (res) {
          if (res.data) {
            _this3.opStatistics = res.data.current;
            _this3.opStatisticsPrevious = res.data.previous ? res.data.previous : null;
        ...
        _this3.loadingliveOperationalStatisticsPie = false;
      });
    };
...
define('text!app-footer/app-footer.html', ['module'], function(module) { module.exports = "<template><footer class=\"page-footer\"><div class=\"footer-copyright\"><div class=\"container\">Copyright © 2017 <a class=\"grey-text text-lighten-4\" href=\"http://razrgen.com\" target=\"_blank\">RAZRGen</a> All rights reserved. <span class=\"right\">Design and Developed by <a class=\"grey-text text-lighten-4\" href=\"http://razrlab.com\">RAZRlab</a></span></div></div></footer></template>"; });
define('text!app-navbar/app-navbar.html', ['module'], function(module) { module.exports = "<template><aside id=\"left-sidebar-nav\"><ul id=\"slide-out\" class=\"side-nav fixed leftside-navigation\"><li class=\"user-details cyan darken-2\"><div class=\"row\"><div class=\"col col s4 m4 l4\"><img src=\"./uploads/users/${user.imageUrl}\" class=\"circle responsive-img valign profile-image\"></div><div class=\"col col s8 m8 l8\"><ul id=\"profile-dropdown\" class=\"dropdown-content\"><li><a a route-href=\"route: profile\"><i class=\"mdi-action-face-unlock\"></i> Profile</a></li><li show.bind=\"(user.privileges.indexOf(0) > -1)\"><a route-href=\"route: administration\"><i class=\"mdi-action-settings\"></i>Admin</a></li><li><a href=\"#\"><i class=\"mdi-communication-live-help\"></i> Help</a></li><li class=\"divider\"></li><li><a click.delegate=\"logout()\"><i class=\"mdi-hardware-keyboard-tab\"></i> Logout</a></li></ul><a class=\"btn-flat dropdown-button waves-effect waves-light white-text profile-btn\" href=\"#\" data-activates=\"profile-dropdown\">${user.name}<i class=\"mdi-navigation-arrow-drop-down right\"></i></a><p class=\"user-roal\">Administrator</p></div></div></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: overview\"><i class=\"mdi-action-dashboard\"></i> Dashboard</a></li><li class=\"no-padding\"><ul class=\"collapsible collapsible-accordion\"><li class=\"bold\"><a class=\"collapsible-header waves-effect waves-cyan\"><i class=\"mdi-toggle-radio-button-on\"></i>Gensets</a><div class=\"collapsible-body\"><ul><li><a route-href=\"route: project-list\"><i class=\"mdi-communication-business\"></i>All Projects</a></li><li><a route-href=\"route: asset-list\"><i class=\"mdi-image-flash-on\"></i>All Gensets</a></li></ul></div></li></ul></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: alarms\"><i class=\"mdi-social-notifications-on\"></i> Alerts <span show.bind=\"alarmsCount > 0\" class=\"new badge red darken-4\">${alarmsCount}</span></a></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: map\"><i class=\"mdi-social-public\"></i>Map</a></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: locations\"><i class=\"mdi-maps-pin-drop\"></i>POI</a></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: geofences\"><i class=\"mdi-maps-layers\"></i>Geofences</a></li><li class=\"bold\"><a class=\"waves-effect waves-cyan\" route-href=\"route: commands\"><i class=\"mdi-notification-sms\"></i>Commands</a></li><li class=\"li-hover\"><div class=\"divider\"></div></li><li class=\"li-hover\"><p class=\"ultra-small margin more-text\">Analytics</p></li><li><a route-href=\"route: report-asset-utilization\"><i class=\"mdi-action-trending-up\"></i>Genset Utilization</a></li><li class=\"li-hover\"><div class=\"divider\"></div></li><li class=\"li-hover\"><p class=\"ultra-small margin more-text\">MORE</p></li><li><a><i class=\"mdi-communication-live-help\"></i> Help</a></li><li class=\"li-hover\"><div class=\"divider\"></div></li></ul><a href=\"#\" data-activates=\"slide-out\" class=\"sidebar-collapse btn-floating btn-medium waves-effect waves-light hide-on-large-only darken-2\"><i class=\"mdi-navigation-menu\"></i></a></aside><div class=\"fixed-action-btn\"><a class=\"btn-floating btn-large red\"><i class=\"large mdi-navigation-apps\"></i></a><ul><li><a class=\"btn-floating yellow darken-1 tooltipped\" style=\"transform:scaleY(.4) scaleX(.4) translateY(40px);opacity:0\" data-position=\"left\" data-delay=\"250\" data-tooltip=\"Support\" click.delegate=\"showSupportDialog()\"><i class=\"large mdi-communication-quick-contacts-dialer\"></i></a></li><li show.bind=\"(user.privileges.indexOf(1) > -1)\"><a class=\"btn-floating green tooltipped\" style=\"transform:scaleY(.4) scaleX(.4) translateY(40px);opacity:0\" data-position=\"left\" data-delay=\"250\" data-tooltip=\"Create Asset\" route-href=\"route: asset-admin\"><i class=\"large mdi-image-flash-on\"></i></a></li><li show.bind=\"(user.privileges.indexOf(2) > -1)\"><a class=\"btn-floating green tooltipped\" style=\"transform:scaleY(.4) scaleX(.4) translateY(40px);opacity:0\" data-position=\"left\" data-delay=\"250\" data-tooltip=\"Create Project\" route-href=\"route: project-admin\"><i class=\"large mdi-communication-business\"></i></a></li></ul></div><div id=\"supportDialog\" ref=\"supportDialog\"></div></template>"; });
...
define('text!login/user-password.html', ['module'], function(module) { module.exports = "<template><require from=\"./user-password.css\" as=\"scoped\"></require><div id=\"login-page\" class=\"row\"><div class=\"col s12 z-depth-4 card-panel login-card\"><form class=\"login-form\" submit.delegate=\"login()\"><div class=\"row\"><div class=\"input-field col s12 center\"><p class=\"center login-form-text\">RAZRlab</p></div></div><div class=\"row margin\"><div class=\"input-field col s12\"><i class=\"mdi-social-person-outline prefix\"></i> <input id=\"username\" type=\"text\" value.bind=\"model.loginName\" name=\"loginName\" placeholder=\"Username\" required></div></div><div class=\"row margin\"><div class=\"input-field col s12\"><i class=\"mdi-action-lock-outline prefix\"></i> <input id=\"password\" type=\"password\" value.bind=\"model.password\" name=\"password\" placeholder=\"Password\" required></div></div><div class=\"row\"><div class=\"input-field col s12 m12 l12 login-text\"><input type=\"checkbox\" id=\"remember-me\"><label for=\"remember-me\">Remember me</label></div></div><div class=\"row\"><div class=\"input-field col s12\"><button disabled.bind=\"loading\" class=\"btn btn-primary btn waves-effect waves-light col s12\">${loginBtnText}</button></div></div><div class=\"row\"><div class=\"input-field col s6 m6 l6\"></div><div class=\"input-field col s6 m6 l6\"></div></div></form></div></div></template>"; });
define('text!overview/overview.html', ['module'], function(module) { module.exports = "<template><div id=\"card-stats\"><div class=\"row\"><div class=\"col s12 m6 l3\"><div class=\"card\"><div class=\"card-content blue darken-4 white-text\"><div class=\"row\"><div class=\"col s3\"><i class=\"mdi-av-timer medium\"></i></div><div class=\"col s9\"><h4 class=\"card-stats-number\">${opStatistics.operationalToday}</h4><p class=\"card-stats-title\">Operational today</p></div></div></div><div class=\"card-action blue darken-4\" show.bind=\"opStatisticsPrevious\"><div id=\"clients-bar\"><p class=\"card-stats-compare\"><span class=\"green-text text-lighten-5\"><i class=\"mdi-hardware-keyboard-arrow-${(opStatistics.operationalToday - opStatisticsPrevious.operationalToday) > 0 ? 'up' : 'down'}\"></i> ${(opStatistics.operationalToday - opStatisticsPrevious.operationalToday)*100}% since yesterday</span></p></div></div></div></div><div class=\"col s12 m6 l3\"><div class=\"card\"><div class=\"card-content blue darken-3 white-text\"><div class=\"row\"><div class=\"col s3\"><i class=\"mdi-maps-beenhere medium\"></i></div><div class=\"col s9\"><h4 class=\"card-stats-number\">${opStatistics.readyForDeployment}</h4><p class=\"card-stats-title\">Ready to be deployed</p></div></div></div><div class=\"card-action blue darken-3\" show.bind=\"opStatisticsPrevious\"><div id=\"sales-compositebar\"><p class=\"card-stats-compare\"><span class=\"green-text text-lighten-5\"><i class=\"mdi-hardware-keyboard-arrow-${(opStatistics.readyForDeployment - opStatisticsPrevious.readyForDeployment) > 0 ? 'up' : 'down'}\"></i> ${(opStatistics.readyForDeployment - opStatisticsPrevious.readyForDeployment)*100}% from yesterday</span></p></div></div></div></div><div class=\"col s12 m6 l3\"><div class=\"card\"><div class=\"card-content blue darken-2 white-text\"><div class=\"row\"><div class=\"col s3\"><i class=\"mdi-maps-local-pharmacy medium\"></i></div><div class=\"col s9\"><h4 class=\"card-stats-number\">${opStatistics.maintenance}</h4><p class=\"card-stats-title\">In maintenance</p></div></div></div><div class=\"card-action blue darken-2\" show.bind=\"opStatisticsPrevious\"><div id=\"profit-tristate\"><p class=\"card-stats-compare\"><span class=\"green-text text-lighten-5\"><i class=\"mdi-hardware-keyboard-arrow-${(opStatistics.maintenance - opStatisticsPrevious.maintenance) > 0 ? 'up' : 'down'}\"></i> ${(opStatistics.maintenance - opStatisticsPrevious.maintenance)*100}% from yesterday</span></p></div></div></div></div><div class=\"col s12 m6 l3\"><div class=\"card\"><div class=\"card-content blue darken-1 white-text\"><div class=\"row\"><div class=\"col s3\"><i class=\"mdi-content-report medium\"></i></div><div class=\"col s9\"><h4 class=\"card-stats-number\">${opStatistics.toBeServiced}</h4><p class=\"card-stats-title\">To be serviced</p></div></div></div><div class=\"card-action blue darken-1\" show.bind=\"opStatisticsPrevious\"><div id=\"invoice-line\"><p class=\"card-stats-compare\"><span class=\"green-text text-lighten-5\"><i class=\"mdi-hardware-keyboard-arrow-${(opStatistics.toBeServiced - opStatisticsPrevious.toBeServiced) > 0 ? 'up' : 'down'}\"></i> ${(opStatistics.toBeServiced - opStatisticsPrevious.toBeServiced)*100}% from yesterday</span></p></div></div></div></div></div></div><div class=\"card waves-effect waves-block waves-light\"><div show.bind=\"loadingPowerOutputBar\" class=\"k-loading-mask\" style=\"width:100%;height:100%\"><span class=\"k-loading-text\">Loading...</span><div class=\"k-loading-image\"><div class=\"k-loading-color\"></div></div></div><div class=\"card-content\"><div id=\"powerOutputBar\"></div></div></div><div class=\"card\"><div show.bind=\"loadingMap\" class=\"k-loading-mask\" style=\"width:100%;height:100%\"><span class=\"k-loading-text\">Loading...</span><div class=\"k-loading-image\"><div class=\"k-loading-color\"></div></div></div><div id=\"overviewMap\" style=\"height:400px\"></div><div ref=\"legend\"></div></div><div class=\"row\"><div class=\"col s12 m6 l6\"><div class=\"card waves-effect waves-block waves-light\"><div show.bind=\"loadingliveOperationalStatisticsPie\" class=\"k-loading-mask\" style=\"width:100%;height:100%\"><span class=\"k-loading-text\">Loading...</span><div class=\"k-loading-image\"><div class=\"k-loading-color\"></div></div></div><div class=\"card-content\"><canvas id=\"operationalPie\"></canvas></div></div></div><div class=\"col s12 m6 l6\"><div class=\"card\"><div class=\"collapsible-header active red darken-4 white-text\"><i class=\"mdi-alert-warning\"></i>Recent Alarms</div><div id=\"miniAlarms\"></div></div></div></div></template>"; });
